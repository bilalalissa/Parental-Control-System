...
| Foreground/running apps | Stage 04 metadata plus Stage 06E signed-identity restrictions | Stage 08 bounded names/executable identities | Not available |
| Browser-tab metadata | Visible enrolled Chromium/Firefox extensions plus Stage 06E Safari local-test extension | Stage 08 visible Chrome/Edge extension; title/origin only | Not available |
| Reliable uptime or login state | Stage 04 candidate | Stage 07 candidate | Not available |
| Text chat and announcements | Stage 04 candidate | Stage 08 text chat/notifications | While app is active in a later stage |
