...
test("stage tracker uses an allowed state and identifies one active stage", async () => {
  ...
  assert.equal(active[0].status, "APPROVED");
...
test("README and license identify pre-release status and terms", async () => {
  ...
  assert.match(readme, /Stages 00–06 are merged; STAGE-06A `0\.6\.1-rc\.5` is approved and awaiting a separate merge command; STAGE-07 has not begun/);
