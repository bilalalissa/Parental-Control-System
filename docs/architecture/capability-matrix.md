...
This matrix is a contract for truthful UI and protocol negotiation, not a statement that Stage 00 implements the capabilities.
...
| Boot time / reliable uptime | Local Mac only | Planned | Planned | **Not available** | Device information only where supported |
| Login/logout/lock state | Local Mac only | Planned | Planned | **Not available** | Not desktop session semantics |
| Foreground/running applications | Controller process only | Metadata planned | Metadata planned | **Not available** | **Not available** |
...
| Text chat | Parent UI | Planned | Planned | While active; notifications best effort | Through visible child app only |
| Request more time | Parent decision UI | Planned | Planned | Planned with Family Controls flow | Through visible child app only |
