...
- `ParentalControlBrowserSharing-0.6.0-rc.1.zip`: SHA-256 `c19027104b2370a8783f080286c68d52b86381bb8a60ed19aa0af2d9773d3503`; ZIP integrity and its exact eight expected extension files passed; it contains no signing-key file extensions.
- An isolated unpaired daemon smoke run completed normally in 5.26 seconds with 0.00 seconds reported user/system CPU, 14,811,136-byte maximum resident set size, and a 4,293,208-byte peak footprint. The temporary root was removed immediately.
