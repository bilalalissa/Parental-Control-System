...
DERIVED="$ROOT_DIR/.artifacts/derived-data/stage-05"
...
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 5002" "$CONTENTS/Info.plist"
...
/usr/bin/codesign --force --sign - --identifier com.bilalalissa.ParentalControlAgent.daemon "$HELPERS/ParentalControlAgentDaemon"
/usr/bin/codesign --force --sign - --identifier com.bilalalissa.ParentalControlAgent.user "$HELPERS/ParentalControlAgentUser"
/usr/bin/codesign --force --sign - --identifier com.bilalalissa.ParentalControlAgent.ctl "$HELPERS/ParentalControlAgentCtl"
/usr/bin/codesign --force --sign - --identifier com.bilalalissa.ParentalControlBrowserHost "$HELPERS/ParentalControlBrowserHost"
/usr/bin/codesign --force --sign - --identifier com.bilalalissa.ParentalControlChild "$MACOS/ParentalControlChild"
/usr/bin/codesign --force --sign - --identifier com.bilalalissa.ParentalControlChild "$APP"
