...
OUTPUT_ICNS="${1:-$ROOT_DIR/.artifacts/derived-data/stage-04/ControllerIcon.icns}"
WORK_DIR="$ROOT_DIR/.artifacts/derived-data/stage-04/controller-icon-generation"
