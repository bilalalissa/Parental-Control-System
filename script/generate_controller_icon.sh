...
OUTPUT_ICNS="${1:-$ROOT_DIR/.artifacts/derived-data/stage-05/ControllerIcon.icns}"
WORK_DIR="$ROOT_DIR/.artifacts/derived-data/stage-05/controller-icon-generation"
