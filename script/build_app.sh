...
DERIVED_DIR="${CONTROLLER_DERIVED_DIR:-$ROOT_DIR/.artifacts/derived-data/stage-06e}"
...
VERSION="${CONTROLLER_VERSION:-0.6.5-rc.10}"
BUILD_NUMBER="${CONTROLLER_BUILD_NUMBER:-6510}"
COMMIT="$(/usr/bin/git -C "$ROOT_DIR" rev-parse --short=12 HEAD)"
